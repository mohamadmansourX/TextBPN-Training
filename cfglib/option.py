...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--gpu",  help="set gpu id", type=str)
        self.parser.add_argument('--resume', default=None, type=str, help='Path to target resume checkpoint')
        self.parser.add_argument('--num_workers',  type=int, help='Number of workers used in dataloading')
        self.parser.add_argument('--cuda', type=str2bool, help='Use cuda to train model')
        self.parser.add_argument('--mgpu', action='store_true', help='Use multi-gpu to train model')
        self.parser.add_argument('--save_dir', default='checkpoints', help='Path to save checkpoint models')
        self.parser.add_argument('--vis_dir',  help='Path to save visualization images')
        self.parser.add_argument('--log_dir', help='Path to tensorboard log')
        ...
        self.parser.add_argument('--pretrain',  type=str2bool, help='Pretrained AutoEncoder model')
        self.parser.add_argument('--verbose', '-v',  type=str2bool, help='Whether to output debug info')
        ...
        self.parser.add_argument('--val_freq', type=int, help='do validation every # iterations')
